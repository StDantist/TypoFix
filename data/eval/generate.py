...
# Були ПОВНІСТЮ відсутні у словнику (clean_corpus.py відкидав 1-літерні) — корінь
# бага з живого тесту. Беремо лише слова з ЛІТЕРНИМ en-двійником (пунктуаційні
# б→',' ж→';' є→"'" пропускаємо — лишок як текст некоректний). Кожен двійник
# (f,d,p,q,s,j,e,z) — НЕ валідне англ. слово (дзеркальна перевірка, 0 конфліктів).
...
# літерним двійником (пунктуаційні `аж→f;`, `бо→,j`, `ну→ye`(архаїчне en) — поза
# списком). switch=true, typed=en, intended=uk.
UK_SHORT2 = [
    "ви", "га", "ге", "де", "до", "за", "зі", "із", "ми", "на", "не", "ні",
    "по", "та", "те", "ти", "то", "це", "ці", "ця", "чи", "як", "би", "ой",
    "он", "от",
]
...
def build():
    ...
    # POSITIVE: 1-літерні службові укр. у en-розкладці (на екрані латинський двійник)
    for w in UK_SHORT1:
